...
test("모의 번호는 스크린리더가 한 자씩 읽도록 띄어 쓴다(실제 번호 오인 방지)", () => {
  assert.equal(spellOutDisplayNumber("1500-0000"), "1 5 0 0, 0 0 0 0");
  assert.equal(spellOutDisplayNumber("160-0000"), "1 6 0, 0 0 0 0");
});

...
// 동작한다.
//
// ⭐ 오늘(§59 커밋 C 이후) 이 파일의 실제 실행 여부: 도구가 실제로 선언되는 시나리오(SMS 카탈로그
// 보유 시나리오 대부분 · bank-security-verify-scam advanced)에서는 이제 **도달 가능**하다 —
// `GeminiVoiceSession.tsx:409-414`의 옛 "오늘 도달 불가" 주석은 이 커밋으로 **더 이상 참이 아니다**
// (그 파일의 갱신된 주석 참고).
